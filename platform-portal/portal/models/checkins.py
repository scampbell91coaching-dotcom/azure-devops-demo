...
class WeeklyCheckin(db.Model):  # type: ignore[name-defined]
    ...
    carbohydrate_average_g = db.Column(db.Integer)
    fat_average_g = db.Column(db.Integer)
    fibre_average_g = db.Column(db.Float)
    nutrition_data_source = db.Column(db.String(40))
    nutrition_period_start = db.Column(db.Date)
    nutrition_period_end = db.Column(db.Date)
