...
def test_rollout_phases_are_ordered_and_explicit():
    ...
    assert "organizations" in verify.CONTROL_TABLES
    assert "organization_memberships" in verify.CONTROL_TABLES
    assert "coach_athlete_assignments" in verify.CONTROL_TABLES
